...
<div class="" style="padding: 1%;">
       ...
       <div class="col-12 align-self-center" style="background:black;border-radius: 5px;">
            <h3 class="text-center" style="color:white;">CUENTA # {{$id_cuenta}}</h3>
       </div>
       <div class="col-12 align-self-center " style="background:rgba(0,0,0,.5);border-radius: 5px;">
         	</br></br>
         	 	<p>
 					      <a class="btn btn-success"style="border-radius: 50%;"  data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
...
<div class="collapse col-md-5 col-sm-12" id="collapseExample" style="padding: 1%;">
...
<div  style="width: 100%; height: 400px; overflow-y: scroll;" >
    	...
    	<table class="table" style=" font-size: 10px;">
           ...
           <td scope="col-1">$ {{$car->precio_publico}}</th>
     			 <td scope="col-1">
      				<button class="btn btn-success ordenar" value="{{$car->id_carta}}" style="border-radius: 50%;"   role="button" aria-expanded="false" aria-controls="collapseExample">
    					<i class="material-icons">
                ...
                @if($IPHOST==$IPCLIENT)
                    ...
                    <div clas="card-head">
                            <h5 class="card-title" align="center" style="color:white">
                                <a class="btn btn-info imprime" value="{{$id_cuenta}}"style="border-radius: 50%;"  data-toggle="collapse"  role="button" aria-expanded="false" aria-controls="collapseExample">
                                    <i class="material-icons">print</i>
                                </a>
                                <a class="btn btn-primary guardar"style="border-radius: 50%;"  data-toggle="collapse"  role="button" aria-expanded="false" aria-controls="collapseExample">
                                    <i class="material-icons">save</i>
                                </a>
                                <a class="btn btn-danger eliminar"style="border-radius: 50%;"  data-toggle="collapse"  role="button" aria-expanded="false" aria-controls="collapseExample">
    		                	          ...
    		                	          <tr id="tr{{$car->id_venta}}">
    		                	            ...
    		                	            <td id="td_total_{{$car->id_venta}}"scope="col-1">$ {{$car->total}}</td>
     		               	              <td scope="col-1" style="color:white">	
  			               		              <a class="btn btn-danger elimina_uno"style="border-radius: 50%;"  value="{{$car->id_venta}}" data-toggle="collapse"  role="button" aria-expanded="false" aria-controls="collapseExample">
    		                			             <i class="material-icons">
                          				          delete_forever</i>
  			               		              </a>
      	               		            </td>
